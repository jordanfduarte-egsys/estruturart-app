 ...
 */
public enum DefaultBootstrapBrandUtility implements BootstrapBrand {

    PRIMARY(R.color.colorWhite);

    private final int textColor;
    private final int color;

    DefaultBootstrapBrandUtility(int color) {
        this.color = color;
        this.textColor =  android.R.color.white;
    }

    DefaultBootstrapBrandUtility(int color, int textColor) {
        this.color = color;
        this.textColor =  textColor;
    }

    public static DefaultBootstrapBrandUtility fromAttributeValue(int attrValue) {
        switch (attrValue) {
            case 0:
                return PRIMARY;
            default:
